 ...
 RSpec.describe "/forms/:type", type: :feature do
  ...
  it "includes intro text" do
    @intro = FactoryBot.create(:webpage, title: "Copy Request Intro", body: ActionText::Content.new("This is the introductory text."))
    visit "/forms/copy-request"
    container = page.find(".form-intro")
  ...
  it "includes footer text" do
    @footer = FactoryBot.create(:webpage, title: "Copy Request Footer", body: ActionText::Content.new("This is the footer text."))
    visit "/forms/copy-request"
