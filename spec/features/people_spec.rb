...
RSpec.describe "/people", type: :feature do
  it "displays all people" do
    dept_head = FactoryBot.create(:person, :with_image, title: "Not a Lemon Head", department: "Human Resources",
                                                        head: true)
    default_person = FactoryBot.create(:person, :with_image, title: "Lemon Head", department: "Human Resources",
                                                             head: false)
