...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post catalogs_url, params: { catalog: { code: @catalog.code, season: @catalog.season, year: @catalog.year } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { code: @catalog.code, season: @catalog.season, year: @catalog.year } }
