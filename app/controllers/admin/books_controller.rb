...
module Admin
  class BooksController < Admin::ApplicationController
    ...
    def set_tabs
      ...
      @tab_content = {}
      @tab_content["book"] = ["sort_title", "author_byline", "edition", "status", "cover_image", "excerpt_image", "excerpt_text", "supplement", "suggested_reading_image", "suggested_reading_label"]
      ...
      @tab_content["guide"] = ["guide_image", "guide_file", "guide_file_label", "guide_text"]
