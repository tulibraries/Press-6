...
module Admin
  class BooksController < Admin::ApplicationController
    ...
    def set_tabs
      ...
      @tab_content = {}
      @tab_content["book"] = ["sort_title", "author_byline", "edition", "status", "cover_image", "cover", "excerpt", "excerpt_text", "toc_file", "toc_label", "supplement", "suggested_reading_image", "suggested_reading_label"]
